...
class TestMain(unittest.TestCase):
    ...
    @patch.object(FileReader, 'load_json', return_value=[
        {"id": 1, "name": "Liza's Cambridge", "price_per_head": 100,
         "location": "Bareng Drive", "contact": "09762969444"}])
    ...
    def test_run_success(self, mock_save_json, mock_load_json):
        ...
        self.assertEqual(main_app.transients, [
            {"id": 1, "name": "Liza's Cambridge", "price_per_head": 100,
             "location": "Bareng Drive", "contact": "09762969444"}])
